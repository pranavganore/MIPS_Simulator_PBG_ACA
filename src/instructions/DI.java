...
public abstract class DI implements I {
	/* Hazards */
	public boolean RAW;
	public boolean WAR;
	public boolean WAW;
	public boolean STRUCT;
	public FunctionalUnit_Type functionalUnit_Type;
	...
	public DI() {
		...
		this.WAW = false;
		this.STRUCT = false;
		this.functionalUnit_Type = FunctionalUnit_Type.UNKNOWN;
	...
	public DI(DI obj) {
		...
		this.functionalUnit_Type = obj.functionalUnit_Type;
	...
	public String getOutputString() {
		return String.format(Simulator.Result_Generator.instructionOutputFormatString,
	...
	public static boolean isLoadStore(DI inst) {
	...
	public static boolean isStore(DI inst) {
